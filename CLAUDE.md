...
- **A dump becomes a Task, and the Broker is what reads it.** Somebody says a Task the way they think of it, most often typed one-handed into a phone, and the Broker turns the sentence into the attributes; the ordinary add form opens filled in, and a person corrects and submits it. That is the usual way a Task is created rather than a shortcut past the form, and it is the single most frequent thing anybody does here. The form stays the gate: nothing the Broker read is written until a person submits it.
